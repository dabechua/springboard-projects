// Resources Help: Google, youtube, mdn, chatgpt
...
console.log("Essentials Elements:", element1, element2);
...
function revealPath({ direction, distance }) {
	console.log(`Go ${distance} meters towards ${direction}.`);
}
...
mixPotion(); //uses defaults
mixPotion({ ingredient1: "Wind"}); // one default
...
function castSpell([firstIng, secondIng]) {
	console.log(`Casting spell with ${firstIng} and ${secondIng}`);
}

castSpell(["Phoenis Feather", "dragon Scale", "Unicorn Hair"]);
