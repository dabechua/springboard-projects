// Code written with guidance from ChatGPT (OpenAI).
...
spacecraft.receiveMessage("Prepare for warp!")

/*
 * Observations:
 * TODO: Explain here.
 * Arrow functions don't bind their own 'this'. Here, 'this' inside 'receivedMessage' does not refer to the 'spacecraft' object. If we used a regular function instead, 'this' would correctly refer to 'spacecraft'
 */
